...
SEARCH_TESTS = [
    ...
    ("strips", [], "astar(lmcount(lm_rhw()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("strips", [], "astar(lmcp(lm_rhw()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("strips", [], "astar(lmcount(lm_hm()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("strips", [], "astar(lmcp(lm_hm()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ...
    ("axioms", [], "astar(lmcut())",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
    ("axioms", [], "astar(lmcount(lm_rhw()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("axioms", [], "astar(lmcp(lm_rhw()))",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
    ("axioms", [], "astar(lmcount(lm_zg()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("axioms", [], "astar(lmcp(lm_zg()))",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
    # h^m landmark factory explicitly forbids axioms.
    ("axioms", [], "astar(lmcount(lm_hm()))",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
    ("axioms", [], "astar(lmcp(lm_hm()))",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
    ("axioms", [], "astar(lmcount(lm_exhaust()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("axioms", [], "astar(lmcp(lm_exhaust()))",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
    ...
    ("cond-eff", [], "astar(lmcut())",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
    ("cond-eff", [], "astar(lmcount(lm_rhw()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("cond-eff", [], "astar(lmcp(lm_rhw()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("cond-eff", [], "astar(lmcount(lm_zg()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("cond-eff", [], "astar(lmcp(lm_zg()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("cond-eff", [], "astar(lmcount(lm_hm()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("cond-eff", [], "astar(lmcp(lm_hm()))",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
    ("cond-eff", [], "astar(lmcount(lm_exhaust()))",
        defaultdict(lambda: returncodes.SUCCESS)),
    ("cond-eff", [], "astar(lmcp(lm_exhaust()))",
        defaultdict(lambda: returncodes.SEARCH_UNSUPPORTED)),
