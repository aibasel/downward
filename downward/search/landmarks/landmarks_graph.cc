...
LandmarksGraph::LandmarksGraph(Exploration *explor) : exploration(explor), landmarks_count(0),
 ...
 */
    ...
    exploration->compute_reachability_with_excludes(lvl_var, lvl_op, level_out, exclude_props, exclude_ops,
						  compute_lvl_op);
...
bool LandmarksGraph::relaxed_task_solvable_without_operator(vector<vector<int> >& lvl_var,
					   vector<hash_map<pair<int, int>, int,
					   hash_int_pair> >& lvl_op,
					   bool level_out,
...
bool LandmarksGraph::
check_action_landmark(const Operator* op) {
