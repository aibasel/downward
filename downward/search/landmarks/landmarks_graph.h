...
public:
    ...
    int get_unused_action_landmark_cost() const {
        return unused_action_landmark_cost;
    }
    void set_unused_action_landmark_cost(int cost) {
        unused_action_landmark_cost = cost;
    }
...
protected:
    ...
    void reset_landmarks_count() {
        landmarks_count = nodes.size();
    }
