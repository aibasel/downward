...
def supports_32bit_builds():
    ...
    if system == "Darwin":
        ...
        try:
            ...
            print "Cannot determine OS version but assuming it supports 32bit builds."
    return True

if not supports_32bit_builds():
    print "macOS High Sierra 10.13.4 and later do not support 32bit builds. Using 64bit builds as default. See issue854 for details."
    DEFAULT = "release64"
    DEBUG = "debug64"
