...
exp.add_fetcher(os.path.expanduser('~/experiments/executed/issue123/2014-09-28-issue123-base-eval'), filter_config_nick=['lama-2011-first-it'])
exp.add_fetcher(os.path.expanduser('~/experiments/executed/issue123/2014-09-28-issue123-v1-eval'), filter_config_nick=['lama-2011-first-it-separated'])
REV_BASE = 'issue123-base'
REV_V1 = 'issue123-v1'
configs = [('%s-lama-2011-first-it' % REV_BASE, '%s-%s-%s-lama-2011-first-it-separated' % (REV_BASE, REV_BASE, REV_V1))]
