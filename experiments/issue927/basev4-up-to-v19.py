...
REVISIONS = ["issue927-base-v4", "issue927-v15", "issue927-v16", "issue927-v17", "issue927-v18", "issue927-v19"]
BUILDS = ["release"]
CONFIG_NICKS = [
    ...
    ('rl-b50k-t900', ['--search', 'astar(merge_and_shrink(merge_strategy=merge_precomputed(merge_tree=linear(variable_order=reverse_level)),shrink_strategy=shrink_bisimulation(greedy=false),label_reduction=exact(before_shrinking=true,before_merging=false),max_states=50000,threshold_before_merge=1))']),
...
exp.add_comparison_table_step(attributes=attributes, revision_pairs=[
    ("issue927-base-v4", "issue927-v15"),
    ("issue927-base-v4", "issue927-v16"),
    ("issue927-base-v4", "issue927-v17"),
    ("issue927-v15", "issue927-v16"),
    ("issue927-v15", "issue927-v17"),
    ("issue927-v17", "issue927-v18"),
