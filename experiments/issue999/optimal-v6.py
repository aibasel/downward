...
def make_comparison_table():
    report = common_setup.ComparativeReport(
        algorithm_pairs=[
            ("issue999-base-seq-opt-bjolp", "issue999-v6-seq-opt-bjolp"),
            ("issue999-base-lm_exhaust", "issue999-v6-lm_exhaust"),
            ("issue999-base-lm_hm", "issue999-v6-lm_hm"),
            ("issue999-base-seq-opt-bjolp-optimal", "issue999-v6-seq-opt-bjolp-optimal"),
...
REVISIONS = ["issue999-base", "issue999-v6"]
