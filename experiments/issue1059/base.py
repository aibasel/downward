...
exp.add_fetcher('data/issue1042-v1-eval', merge=True)
exp.add_comparison_table_step(attributes=attributes, revisions=["issue1042-base", "issue1042-v1"])
