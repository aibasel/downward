...
exp.add_report(AbsoluteReport(attributes=attributes,filter_algorithm=[
    ...
    '%s-sbf-miasm-l-rnd-pba-b50k' % 'issue668-v2',
    '%s-sbf-miasm-rnd-otn-pba-b50k' % 'issue668-v2',
    '%s-sbf-miasm-rnd-nto-pba-b50k' % 'issue668-v2',
    '%s-sbf-miasm-rnd-rnd-pba-b50k' % 'issue668-v2',
]),name='issue668-v2-pba.html')
exp.add_report(AbsoluteReport(attributes=attributes,filter_algorithm=[
    '%s-sbf-miasm-rl-nto-abp-b50k' % 'issue668-v2',
    '%s-sbf-miasm-l-nto-abp-b50k' % 'issue668-v2',
    '%s-sbf-miasm-rnd-nto-abp-b50k' % 'issue668-v2',
    ...
    '%s-sbf-miasm-l-nto-pba-b50k' % 'issue668-v2',
    '%s-sbf-miasm-rnd-nto-pba-b50k' % 'issue668-v2',
    '%s-sbf-miasm-allrnd-b50k' % 'issue668-v2',
]),name='issue668-v2-paper.html')
