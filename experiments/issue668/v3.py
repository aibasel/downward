...
exp.add_report(AbsoluteReport(attributes=attributes,filter_algorithm=[
    '%s-sbf-miasm-rl-otn-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rl-nto-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rl-rnd-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-l-otn-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-l-nto-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-l-rnd-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rnd-otn-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rnd-nto-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rnd-rnd-abp-b50k' % 'issue668-v3',
]),outfile='issue668-v3-abp.html')
exp.add_report(AbsoluteReport(attributes=attributes,filter_algorithm=[
    '%s-sbf-miasm-rl-otn-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rl-nto-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rl-rnd-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-l-otn-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-l-nto-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-l-rnd-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rnd-otn-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rnd-nto-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rnd-rnd-pba-b50k' % 'issue668-v3',
]),name='issue668-v3-pba.html')
exp.add_report(AbsoluteReport(attributes=attributes,filter_algorithm=[
    '%s-sbf-miasm-rl-nto-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-l-nto-abp-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rnd-nto-abp-b50k' % 'issue668-v3',
    ...
    '%s-sbf-miasm-l-nto-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-rnd-nto-pba-b50k' % 'issue668-v3',
    '%s-sbf-miasm-allrnd-b50k' % 'issue668-v3',
]),name='issue668-v3-paper.html')
