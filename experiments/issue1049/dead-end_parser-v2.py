...
def count_dead_ends(content, props):
    empty_first_matches = re.findall(r"Found unreached landmark in initial state with empty first achievers.|Found unreached landmark with empty first achievers.", content)
