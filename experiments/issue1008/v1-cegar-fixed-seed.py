...
exp.add_fetcher('data/issue1008-base-cegar-fixed-seed-eval', filter_algorithm=[
    f'issue1008-base-cpdbs-singlecegar-regularplans-pdb1m-pdbs10m-t100-s{random_seed}',
    f'issue1008-base-cpdbs-singlecegar-wildcardplans-pdb1m-pdbs10m-t100-s{random_seed}',
    f'issue1008-base-cpdbs-multiplecegar-regularplans-pdb1m-pdbs10m-t100-s{random_seed}',
    f'issue1008-base-cpdbs-multiplecegar-wildcardplans-pdb1m-pdbs10m-t100-s{random_seed}',
    f'issue1008-base-cpdbs-multiplecegar-regularplans-pdb1m-pdbs10m-t100-blacklist0.75-stag20-s{random_seed}',
    f'issue1008-base-cpdbs-multiplecegar-wildcardplans-pdb1m-pdbs10m-t100-blacklist0.75-stag20-s{random_seed}',
],merge=True)

exp.add_comparison_table_step_for_revision_pairs(
    revision_pairs=[
        ("issue1008-base", "issue1008-v1"),
    ],
