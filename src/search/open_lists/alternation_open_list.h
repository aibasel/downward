...
public:
    ...
    virtual std::shared_ptr<AlternationOpenListFactory> create_task_specific_AlternationOpenListFactory(std::shared_ptr<AbstractTask> &task);
    virtual std::shared_ptr<AlternationOpenListFactory> create_task_specific_AlternationOpenListFactory(std::shared_ptr<AbstractTask> &task, std::shared_ptr<ComponentMap> &component_map);
};
}
