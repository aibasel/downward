...
class PerStateArrayInformation : public PerStateInformationBase {
    ...
    */
    ...
    PerStateArrayInformation(const PerStateArrayInformation<Entry> &);
    PerStateArrayInformation &operator=(const PerStateArrayInformation<Entry> &);
public:
    ...
    class const_iterator : public std::iterator<std::forward_iterator_tag,
                                                StateID> {
        friend class PerStateArrayInformation<Entry>;
        const PerStateArrayInformation<Entry> &owner;
        const StateRegistry *registry;
        StateID pos;

        const_iterator(const PerStateArrayInformation<Entry> &owner_,
...
public:
    ...
    explicit PerStateArrayInformation(const Entry &default_value_)
