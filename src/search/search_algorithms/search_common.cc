...
//issue559//    const vector<shared_ptr<Evaluator>> &preferred_evaluators, int boost) {
...
//issue559//                    standard_scalar_open_list::BestFirstOpenListFactory>(
...
//issue559//    utils::Verbosity verbosity, const shared_ptr<GEval> &g_eval, int weight,
//issue559//    const shared_ptr<Evaluator> &h_eval) {
...
//issue559//        vector<shared_ptr<Evaluator>>({g_eval, w_h_eval}), "wastar.eval",
//issue559//        verbosity);
//issue559//}
//issue559//
//issue559//shared_ptr<OpenListFactory> create_wastar_open_list_factory(
//issue559//    const vector<shared_ptr<Evaluator>> &evals,
//issue559//    const vector<shared_ptr<Evaluator>> &preferred, int boost, int weight,
//issue559//    utils::Verbosity verbosity) {
//issue559//    utils::verify_list_not_empty(evals, "evals");
//issue559//    shared_ptr<GEval> g_eval = make_shared<GEval>("wastar.g_eval", verbosity);
...
//issue559//        f_evals.push_back(create_wastar_eval(verbosity, g_eval, weight, eval));
//issue559//
//issue559//    return create_alternation_open_list_factory_aux(f_evals, preferred, boost);
//issue559//}
// start issue559 comment
