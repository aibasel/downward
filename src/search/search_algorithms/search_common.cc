...
static shared_ptr<TaskIndependentEvaluator> create_wastar_eval(
    ...
    if (weight == 1) {
        ...
        w_h_eval = make_shared_component<WeightedEval, Evaluator>(
            h_eval, weight, "wastar.w_h_eval", verbosity);
    }
    return make_shared_component<SumEval, Evaluator>(
...
shared_ptr<TaskIndependentOpenListFactory> create_wastar_open_list_factory(
    ...
    utils::verify_list_not_empty(evals, "evals");
    shared_ptr<TaskIndependentEvaluator> g_eval = make_shared_component<GEval, Evaluator>(
...
create_astar_open_list_factory_and_f_eval(
    ...
    shared_ptr<TaskIndependentEvaluator> g =
        make_shared_component<GEval, Evaluator>("astar.g_eval", verbosity);
    shared_ptr<TaskIndependentEvaluator> f =
        make_shared_component<SumEval, Evaluator>(
    ...
    shared_ptr<TaskIndependentOpenListFactory> open = make_shared_component<
