...
shared_ptr<Evaluator> TaskIndependentBlindSearchHeuristic::get_task_specific(
        ...
        std::unique_ptr<ComponentMap> &component_map,
        int depth) const {
    shared_ptr<BlindSearchHeuristic> task_specific_x;
    if (component_map->count(static_cast<const TaskIndependentComponent *>(this))) {
        log << std::string(depth, ' ') << "Reusing task specific BlindSearchHeuristic '" + name + "'..." << endl;
        task_specific_x = dynamic_pointer_cast<BlindSearchHeuristic>(
