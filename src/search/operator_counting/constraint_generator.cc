...
TaskSpecificConstraintGenerator::TaskSpecificConstraintGenerator(const shared_ptr<AbstractTask> &task)
    : components::TaskSpecificComponent(task) {
}

void TaskSpecificConstraintGenerator::initialize_constraints(
