...
public:
    ...
    virtual std::shared_ptr<CostAdaptedTask> create_task_specific_CostAdaptedTask(const std::shared_ptr<AbstractTask> &task, std::shared_ptr<ComponentMap> &component_map, int depth = -1);
};
}
