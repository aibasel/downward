include_guard(GLOBAL)
    ...
    function(set_up_options) option(
        USE_GLIBCXX_DEBUG
...
with this flag, which can lead to hard-to-debug errors." FALSE)
...
option USE_LP to false." TRUE)

            if (USE_GLIBCXX_DEBUG AND USE_LP) message(
                FATAL_ERROR
                ...
                "not supported when an LP solver is used. See issue982 for details.")
                    ...
                    option(
                        ...
                        "If set to YES only libraries that are specifically enabled will be compiled" NO)
