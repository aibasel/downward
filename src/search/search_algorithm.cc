...
shared_ptr<Component> TaskIndependentSearchAlgorithm::create_task_specific_Component(const shared_ptr<AbstractTask> &task, shared_ptr<ComponentMap> &component_map, int depth) {
