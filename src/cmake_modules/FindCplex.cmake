...
# Parse CPLEX version.
file(STRINGS ${CPLEX_INCLUDE_DIRS}/cpxconst.h CPX_VERSION_STR
     REGEX "#define[ ]+CPX_VERSION[ ]+[0-9]+")
string(REGEX MATCH "[0-9]+" CPX_VERSION_STR ${CPX_VERSION_STR})
if(CPX_VERSION_STR)
  math(EXPR CPLEX_VERSION_MAJOR "${CPX_VERSION_STR} / 1000000")
  math(EXPR CPLEX_VERSION_MINOR "${CPX_VERSION_STR} / 10000 % 100")
  math(EXPR CPLEX_VERSION_SUBMINOR "${CPX_VERSION_STR} / 100 % 100")
  set(CPLEX_VERSION
...
if(CPLEX_LIBRARY_RELEASE OR CPLEX_LIBRARY_DEBUG)
    ...
    if(${CPLEX_VERSION} VERSION_GREATER "12.8")
