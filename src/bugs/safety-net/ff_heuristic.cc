...
/*
TODO:
  This does not work for operators without *any* preconditions.
  Supporting these would of course not be difficult, though.
*/
...
FFHeuristic::FFHeuristic() {
  assert(g_ff_helpful_actions || g_mixed_helpful_actions
	 || g_multi_heuristic || g_ff_heuristic_replanning);
