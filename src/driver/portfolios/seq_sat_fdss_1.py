...
CONFIGS = [
    ...
    (49, ["--heuristic", "hff=ff(cost_type=H_COST_TYPE)",
         ...
         "lazy_greedy(hff,hcg,preferred=[hff,hcg],cost_type=S_COST_TYPE)"]),
    # lazy_greedy_ff_1
    (171, ["--heuristic", "h=ff(cost_type=H_COST_TYPE)",
          "--search",
          "lazy_greedy(h,preferred=h,cost_type=S_COST_TYPE)"]),
    # alt_lazy_cea_cg
    (27, ["--heuristic", "hcea=cea(cost_type=H_COST_TYPE)",
         "--heuristic", "hcg=cg(cost_type=H_COST_TYPE)", "--search",
         "lazy_greedy(hcea,hcg,preferred=[hcea,hcg],cost_type=S_COST_TYPE)"]),
    # lazy_wa3_ff_1
    (340, ["--heuristic", "h=ff(cost_type=H_COST_TYPE)",
          "--search",
          "lazy_wastar(h,w=3,preferred=h,cost_type=S_COST_TYPE)"]),
    # alt_eager_ff_cg
    (76, ["--heuristic", "hff=ff(cost_type=H_COST_TYPE)",
         "--heuristic", "hcg=cg(cost_type=H_COST_TYPE)", "--search",
         "eager_greedy(hff,hcg,preferred=[hff,hcg],cost_type=S_COST_TYPE)"]),
    # eager_greedy_ff_1
    (88, ["--heuristic", "h=ff(cost_type=H_COST_TYPE)",
          "--search",
          "eager_greedy(h,preferred=h,cost_type=S_COST_TYPE)"]),
    # alt_eager_ff_add
    (90, ["--heuristic", "hff=ff(cost_type=H_COST_TYPE)",
         "--heuristic", "hadd=add(cost_type=H_COST_TYPE)", "--search",
         "eager_greedy(hff,hadd,preferred=[hff,hadd],cost_type=S_COST_TYPE)"]),
    # lazy_greedy_cea_1
    ...
    (73, ["--heuristic", "hff=ff(cost_type=H_COST_TYPE)",
          ...
          "--search",
          "eager_greedy([hff,hcea,hcg],preferred=[hff,hcea,hcg],cost_type=S_COST_TYPE)"]),
    # lazy_wa3_add_1
    ...
    (166, ["--heuristic", "h=add(cost_type=H_COST_TYPE)",
          "--search",
          "eager(single(sum([g(),weight(h,3)])),preferred=h,cost_type=S_COST_TYPE)"]),
    # eager_wa3_ff_1
...
FINAL_CONFIG = [
    ...
    "--search",
    "iterated(eager(single(sum([g(),weight(h,3)])),preferred=h,cost_type=S_COST_TYPE),repeat_last=true)"]
